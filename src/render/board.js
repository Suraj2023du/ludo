...
export const THEMES = Object.freeze({
  ...
  wood: {
    ...
    star: '#7a5320',
    players: {
      red: palette('#c0392b', '#7d2018', '#ef8a7d'),
      green: palette('#3d8b40', '#245526', '#8fd292'),
      yellow: palette('#d99a2b', '#9c6b12', '#f6d089'),
      blue: palette('#2f6fa8', '#1c4468', '#8fc0e6'),
    },
  },
  taj: {
    id: 'taj',
    ...
    star: '#9a8468',
    players: {
      red: palette('#c9184a', '#8b0f33', '#ff8fa9'),
      green: palette('#1a7f5a', '#0f5239', '#7fd8bb'),
      yellow: palette('#e0a428', '#a97612', '#f7d78d'),
      blue: palette('#3a5ba0', '#243a68', '#9db4e0'),
    },
  },
  cricket: {
    id: 'cricket',
    ...
    players: {
      red: palette('#e63946', '#a4252f', '#ff8b93'),
      green: palette('#1b998b', '#0f6b61', '#83e0d6'),
      yellow: palette('#f4b93c', '#b8842a', '#ffe08a'),
      blue: palette('#2f74d0', '#1d4c8c', '#89bdf5'),
    },
  },
  space: {
    ...
    star: '#8ef7ff',
    players: {
      red: palette('#ff2e63', '#a30f39', '#ff8fae'),
      green: palette('#00f5a0', '#009e68', '#94ffd6'),
      yellow: palette('#ffd60a', '#bb9b00', '#fff08a'),
      blue: palette('#4cc9f0', '#1a7fa3', '#a9e9ff'),
    },
  },
  monsoon: {
    id: 'monsoon',
    ...
    star: '#4e8ba8',
    players: {
      red: palette('#ef476f', '#a82c4b', '#ff9db3'),
      green: palette('#06d6a0', '#049073', '#8ff2da'),
      yellow: palette('#ffd166', '#c79a2c', '#ffe9ab'),
      blue: palette('#118ab2', '#0a5e7c', '#7fcbe6'),
    },
  },
  diwali: {
    id: 'diwali',
    ...
    star: '#ffd24a',
    players: {
      red: palette('#ff4d6d', '#b3153a', '#ffa5b7'),
      green: palette('#2dd4a7', '#12886c', '#9bf0d9'),
      yellow: palette('#ffc75f', '#c08a1e', '#ffe6b0'),
      blue: palette('#7b8cff', '#3d4bb5', '#bcc4ff'),
    },
  },
});
